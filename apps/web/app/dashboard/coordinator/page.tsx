  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <DashboardHeader title="Aula Virtual — Coordinador" />
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          ...
          <div className="wine-gradient rounded-2xl p-6 text-white mb-6 animate-fade-in-up">
            ...
            <p className="text-white/60 text-sm mt-1">Panel de coordinador académico</p>
          </div>

          {/* Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 animate-fade-in-up delay-100">
            {[
              { label: 'Programas', value: '0', icon: BookOpen },
              { label: 'Cursos', value: '0', icon: GraduationCap },
              { label: 'Instructores', value: '0', icon: Users },
